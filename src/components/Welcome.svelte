...
<section class="xs-welcome-slider">
    ...
    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1278px, 0px, 0px); transition: all 0s ease 0s; width: 4476px;"><div class="owl-item cloned" style="width: 639.333px;"><div class="xs-welcome-content" style="background-image: url(assets/images/slide2.png);">
            ...
            <div class="xs-black-overlay"></div>
        </div></div><div class="owl-item active" style="width: 639.333px;"><div class="xs-welcome-content" style="background-image: url(assets/images/slide1.png);">
            <div class="container">
                <div class="xs-welcome-wraper color-white">
            ...
            <div class="xs-black-overlay"></div>
        </div></div><div class="owl-item cloned" style="width: 639.333px;"><div class="xs-welcome-content" style="background-image: url(assets/images/slide1.png);">
            <div class="container">
                <div class="xs-welcome-wraper color-white">
                    <h2>Hunger is stalking the globe</h2>
                    <p>Hundreds of thousands of children experiencing or witnessing assault <br> and other
